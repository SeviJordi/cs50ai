...
def load_data(filename):
    ...
    with open(filename) as f:
        ...
        for row in reader:
            ...
            for i in ['ProductRelated_Duration', 'BounceRates', 'ExitRates', 'PageValues', 'SpecialDay']:
                new_evidence.append(float(row[i]))
            
            

            new_evidence.append(int(mapping_months[row['Month']]))
            for i in ['OperatingSystems', 'Browser', 'Region', 'TrafficType']:
                new_evidence.append(int(row[i]))
